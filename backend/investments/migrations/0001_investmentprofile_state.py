...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("accounts", "0004_move_investmentprofile_to_investments"),
            ...
            state_operations=[
                migrations.CreateModel(
                    ...
                    fields=[
                        ...
                        (
                            "available_asset",
                            models.PositiveIntegerField(verbose_name="투자 가능 자산"),
                        ),
                        (
                            "risk_type",
                            models.CharField(
                        ...
                        (
                            "interest_industries",
                            models.JSONField(default=list, verbose_name="관심 산업"),
                        ),
                        (
                            "created_at",
